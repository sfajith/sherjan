      ...
      <div className="lg:grid lg:grid-cols-2 flex flex-col lg:flex-row lg:gap-x-10 lg:items-center mt-10">
        ...
        <div className="flex flex-col mt-4 items-center">
          ...
          <Subtext
            ...
            } position={"lg:text-left"} a={<a href="/kanbanease" target='_blank' className="text-[#b6bcc6] hover:text-red-300 transition-colors  ease-linear">Development walkthrough here</a>}
          /> 
